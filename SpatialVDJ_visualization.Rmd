...
circle_data <- qupath %>% 
  ...
  dplyr::filter(spot == "TumA1_AAGGTGATAAACCAGC-1")
...
# Save to GeoJSON
geojson_write(circle_sf, file = "/Users/tili/Desktop/CIIR/results/colocalization/BCSA3TumA1_TR_clone602_circle_data.geojson")
